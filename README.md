...
- 모든 플러그인은 **RPG Maker MZ 전용**입니다. RPG Maker MV 등 다른 버전과는 호환되지 않을 수 있습니다.
- 플러그인 적용 전 프로젝트 백업을 권장합니다.
...
본 플러그인은 자유롭게 사용, 수정, 재배포가 가능합니다.  
게임 엔딩 크레딧 또는 게임 내 플러그인 목록에 **Akena** 표기를 권장합니다.
